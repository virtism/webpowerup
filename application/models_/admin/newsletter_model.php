<?php
  class Newsletter_Model extends CI_Model {
    ...
    function __construct()
    {
     ...
     {
         $query_str = "INSERT INTO newsletter(news_subject,news_body,news_recipient_group,news_date_created) VALUES (?,?,?,?)";
...
//                $data[] = $row;
            ...
            if($items->news_date_sent == '' || $items->news_date_sent == 'NULL'){
              $link='<a href=" '. base_url().'index.php/administrator/newsletter/send/'.$items->news_id.' " >   [Click Here To Send]</a>|';  
            }
                ...
                $output .='     <tr>
                          ...
                          <td><div style="color:blue;">'.$link. '<a href=" '. base_url().'index.php/administrator/newsletter/view/'.$items->news_id.' " >View</a>|<a  href=" '. base_url().'index.php/administrator/newsletter/edit/'.$items->news_id.' " > Edit </a>|<a href= "'. base_url().'index.php/administrator/newsletter/delete/'.$items->news_id.'" > Delete </a></div></td>
                         </tr>';
            }
