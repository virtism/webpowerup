  ...
  class Autoresponders_Management extends CI_Controller{
	  ...
	  { 
		...
		$this->breadcrumb->add_crumb('Create Autoresponder' ); 		
	   	$show_data['autoresponds'] = $this->Autoresponders_Model->get_all_autoresponder();
	   	$show_data['site_id'] = $site_id;
	  
	  $this->template->write_view('content','autoresponder/autoresponders_management_view',$show_data);
