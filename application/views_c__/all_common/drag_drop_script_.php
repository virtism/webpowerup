			...
			//	alert(itemid);
				...
				if(itemid == "image")
				{
					var html        =  '<div class="dragbox" id="item'+count+'"><img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'item'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';									
										html = html + '<a id="image_'+count+'" href="<?=base_url().index_page()?>media/index/'+count+'" ><span class="menu'+count+'" id="menu_id_'+count+'"><img style="width: 200px; height: 150px ;" src="<?=base_url()?>images/na.jpg" id="temp_image_'+count+'" name="para_'+count+'" onclick="box_load(\'image_'+count+'\')" title = " " alt = ""  /></span></a><input type="hidden" name="control_type[]" value="image" /><input type="hidden" id="input_temp_image_'+count+'" name="content[]" value="" /> <input type="hidden" name="image-para[]" value="" /><div class="contextMenu" id="myMenu'+count+'" style="display:none;"><ul><li id="properties"><a id="custom_open" href="<?=base_url().index_page()?>media/load_properties/'+count+'"> </a> <img src="<?=base_url()?>images/properties.png"/> Image Properties</li></ul></div></div></div></div>';
				...
				if(itemid == "content_image")
				{
					...
					var html        =  '<div class="dragbox" id="item'+count+'"><img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'item'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';
										html = html + '<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td align="left"  valign="top" style="padding-right:10px"><textarea cols="86" class="editor_ta" rows="1" id="para_'+count+'" name="content[]" ></textarea><input type="hidden" name="control_type[]" value="para-image" /><input type="hidden" id="input_temp_image_'+count+'" name="image-para[]" value="" /></td><td align="center"><a id="image_'+count+'" href="<?=base_url().index_page()?>media/index/'+count+'" ><img src="<?=base_url()?>images/na.jpg" id="temp_image_'+count+'" name="para_'+count+'" onclick="box_load(\'image_'+count+'\')" title = " " alt = ""  /></a></td></tr></table>';
