<script type="text/javascript">
   ...
   function save_to_db_img(element_id)
			...
			//	alert(itemid);
				...
				if(itemid == "image")
				{
					var html        =  '<div class="dragbox" id="image-'+count+'"><img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'image-'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';									
										html = html + '<a class="menu-instruction" id="image_'+count+'" href="<?=base_url()?>index.php/media/index/'+count+'" ><span class="menu'+count+'" id="menu_id_'+count+'"><p>Right Click for More_'+count+'...</p><img style="width: 200px; height: 150px ;" src="<?=base_url()?>images/edit_image.jpg" id="temp_image_'+count+'" name="para_'+count+'" onclick="box_load(\'image_'+count+'\')" title = "" alt = ""  /></span></a><span class="img_properties'+count+'"><a style="display:none;" id="open_img_properties" href="<?=base_url()?>index.php/media/load_properties/'+count+'"><img src="<?=base_url()?>images/image_properties.jpg"/></a></span><input type="hidden" name="control_type[]" value="image" /><input type="hidden" name="sort_order[]" value="image-'+count+'" /><input type="hidden" id="input_temp_image_'+count+'" name="content[]" value="" /> <input type="hidden" name="image-para[]" value="" /><div class="contextMenu" id="myMenu'+count+'" style="display:none;"><ul><li id="properties"><a id="custom_open" href="<?=base_url()?>index.php/media/load_properties/'+count+'"></a><img src="<?=base_url()?>images/properties.png"/> Image Properties</li></ul></div></div></div></div>';
				...
				if(itemid == "video")
				{
					var html        =  '<div class="dragbox" id="video-'+count+'"><img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'video-'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';									
										html = html + '<div id="temp_video_'+count+'"><a class="menu-instruction" id="video_'+count+'" href="<?=base_url()?>index.php/media/video_index/'+count+'" ><img style="width: 200px; height: 150px ;" src="<?=base_url()?>images/video.png" id="temp_video_'+count+'" name="para_'+count+'" onclick="video_box_load(\'video_'+count+'\')" title = " " alt = ""  /></a></div><div id="video_edit_'+count+'"></div><input type="hidden" name="control_type[]" value="video" /><input type="hidden" name="sort_order[]" value="video-'+count+'" /><input type="hidden" id="input_temp_video_'+count+'" name="content[]" value="" /> <input type="hidden" name="image-para[]" value="" /></div></div></div>';
											
				}		
				if(itemid == "image_content")
				{
										
					var html        =  '<div class="dragbox" id="image_content-'+count+'">weuroiuweoruwoer<img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'item'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';
										html = html + '<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td align="left"  valign="top"><a class="menu-instruction" id="image_'+count+'" href="<?=base_url()?>index.php/media/index/'+count+'" ><span class="menu'+count+'" id="menu_id_'+count+'"><p>Right Click for More...</p><img style="width: 200px; height: 150px ;" src="<?=base_url()?>images/na.jpg" id="temp_image_'+count+'" name="para_'+count+'" onclick="box_load(\'image_'+count+'\')" title = " " alt = ""  /></span></a></td><td align="center" style="padding-right:10px"><textarea cols="86" class="editor_ta" rows="1" id="para_'+count+'" name="content[]" ></textarea><input type="hidden" name="sort_order[]" value="image-para-'+count+'" /><input type="hidden" name="control_type[]" value="image-para" /><input type="hidden" id="input_temp_image_'+count+'" name="image-para[]" value="" /></td></tr></table>';
				...
				// Start Document Upload 3-6-2012 : Junaid
				if(itemid == "menu_doc")
				{
					var html = '<div class="dragbox" id="doc-'+count+'"><img src="<?=base_url()?>/css/move_arrow.gif" alt="no-image" class="drag-image"><h2 id="'+count+'" value="para_1" onclick="do_collapse(this);" onmouseup="do_fill_data(this.id);" onmouseover="fetch_editor_data(this.id);" >&nbsp;</h2><div style="float:right;margin-top:-20px;margin-right:4px"><a  onclick="remove_item(\'doc-'+count+'\')" id="remove'+itemid+count+'" class="remove'+itemid+count+' x-button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div><div class="dragbox-content" ><div id="item_cart_'+count+'"  style="  position: relative; left: 0px; top:-2px;width:100%;">';									
					html = html + '<a class="menu-instruction" id="doc_'+count+'" href="<?=base_url()?>index.php/menusController/upload_doc/<?=$site_id?>" ><span class="menu'+count+'" id="menu_id_'+count+'"><img style="width: 200px; height: 150px ;" src="<?=base_url()?>images/na.jpg" id="temp_image_'+count+'" name="para_'+count+'" onclick="doc_box_load(\'doc_'+count+'\')" title = " " alt = ""  /></span></a><input type="hidden" name="control_type[]" value="doc_menu" /><input type="hidden" name="sort_order[]" value="doc-'+count+'" /><input type="hidden" id="input_temp_doc_'+count+'" name="content[]" value="" /> <input type="hidden" name="image-para[]" value="" /></div></div></div>';
										
				}	
				// End Document Upload 3-6-2012 : Junaid
	...
	function apply_context_menu(counter,display)
	{
		//alert(counter);
		...
		$('#open_img_properties').show();
		$("#open_img_properties").fancybox({
								'width'                : '70%',
								'height'            : '95%',
								'autoScale'            : false,
								'transitionIn'        : 'none',
