...
function addMenuItem2()
{
    ...
    var id2 = id + 1 + countItems;
    id++;
    cell4.innerHTML = '<td align="center"><div name="dropdown_target1" id="dropdown_target1" class="selector"><span style="-moz-user-select: none;">Select Target</span><select id="menuTarget'+id2+'" name="menuTarget'+countItems+'"><option value="_self" selected="selected" >Same Window</option><option value="_blank">New Window</option></select></div></td>';
	cell4.align = "center";
    ...
    var id2 = id + 1 + countItems;
    id++;
    cell5.innerHTML = '<img src="<?=base_url();?>/images/icon-delete.png" onclick="deleteRow(this.parentNode.parentNode.rowIndex)" />';
    cell5.align = "center";
