...
<?php
    ...
    echo form_open(base_url().'index.php/MyAccount/password_change',$attributes);
...
<table class="registerform" cellspacing="1" summary="Register" style="margin-left: 20px;" >
 <tbody>
 ...
 <tr style="display:none;"><td><input type="hidden" value="N" id="password_is_modified" name="password_is_modified"></td></tr>
   ...
   <tr>                      
      <td class="register-newbie-note" colspan="3" style="">
