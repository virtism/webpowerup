        ...
        <li id="menu_area_<?=$i?>">
          ...
          <ul>
...

                    {
...

                        {
...

							{
								...
								$strLink = base_url()."site_preview/page/".$site_id."/".$menus[$i]['sub_menu'][$j]['page_id'];
            ...
            <?php
				...
				if(isset($sub_menus[$i]) && sizeof($sub_menus[$i]) > 0)
                ...
                <li id="menu_area_<?=$i?>">
...

					{
						...
						for($j=0; $j<sizeof($sub_menus[$i]['sub_menu']); $j++)

                        {
...

							{
								...
								$strLink = base_url()."index.php/site_preview/page/".$site_id."/".$sub_menus[$i]['sub_menu'][$j]['page_id'];

							}

							

							if(empty($sub_menus[$i]['sub_menu'][$j]["page_id"]) && !empty($sub_menus[$i]['sub_menu'][$j]["item_link"]))

							{

								//Checking The Full URL 

								if(strstr($sub_menus[$i]['sub_menu'][$j]["item_link"],"http://"))

								{

									$link_url =  $sub_menus[$i]['sub_menu'][$j]["item_link"];	
...

								{
									...
									$link_url =  "http://".$sub_menus[$i]['sub_menu'][$j]["item_link"];	
...

							{
                   	        ...
                   	        <li><a href="<?=$link_url?>"><?=$sub_menus[$i]['sub_menu'][$j]['item_name']?></a></li>
