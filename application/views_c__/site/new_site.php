...
.mainContentDiv{
    ...
    <dl>
           ...
           <dd>
                ...
                <?php echo form_error('site_title', '<label class="error2">', '</label>'); ?>
           </dd>
    </dl>
    
    <dl>
           <dt>
                 <label  class="NewsletterLabel">Website Subdomain <span class="star">*</span>
                 <small style="font-size:10px;">Enter One Word (no spaces)<br />to identify your site i.e."Company".</small>
                 </label>
           ...
           <dd>
                <input id="site_domain" name="site_domain" type="text"  maxlength="40" size="40" />.<? $url = explode('www.',$_SERVER["HTTP_HOST"]); echo $url[count($url)-1]; ?>
                    <?php echo "<br>".form_error('site_domain', '<label class="error2">', '</label>'); ?>
           </dd>
    </dl>
    ...
    <dl>
           ...
           <dd>
                <input id="site_domain"  name="domain" type="text" maxlength="40" size="40" placeholder="http//:www.example.com"  />
           </dd>
    </dl>
