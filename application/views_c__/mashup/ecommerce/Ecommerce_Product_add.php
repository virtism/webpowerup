...
<p><div class="error_msg" align="center"> <?php echo validation_errors(); ?> </div></p>
 <?php
   ...
   $attributes = array( 'id' => 'add_product' , 'name' => 'add_product', 'onSubmit' => 'return validate()', 'enctype' => 'multipart/form-data');
    echo form_open(base_url().index_page().'Products_Management/create', $attributes); 
                              ...
                              <td  colspan="3" >
                                   <table width="100%" border="0" cellspacing="1" cellpadding="3" id="tblAddrows">
                                              <tr>
                                                ...
                                                <td width="47%" align="center"><input name="attribute[1][title]" type="text" id="title" size="20" value="" /></td>
                                                <td width="47%" align="center"><input name="attribute[1][desc]" type="text" id="order" size="20"  value="" /></td>
