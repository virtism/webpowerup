<script type="text/javascript" language="javascript">
	...
	$(document).ready(function() {
		...
		$("#addRow").click(function(){
			...
			var html = '<div class="DoubleColumn"><div class="ColumnA"><ul><li><input type="text" id="slide_main" name="slide_title'+i+'" size="45" /></li><li><textarea id="slide_desc" name="slide_description'+i+'" rows="10" cols="40"></textarea></li><li><div style=" float:left; width:100%; position:relative;"><select size="1" name="slide_target'+i+'" id="slide_target'+i+'"  style="width:340px"><option value="0">Same Window</option><option value="1">New Window</option></select></div></li></ul></div><div class="ColumnB"><ul><li><input type="text" id="slide_image_url'+i+'" name="slide_image_url'+i+'" size="45" value="URL"  onblur="if(this.value==""){this.value="URL"};" onclick="if(this.value=="URL"){this.value=""};"/></li><li><input type="file" name="slide_image'+i+'" id="slide_image'+i+'" size="35" /></li></ul></div></div>';		
...
<input type="hidden" id="count" name="numImages" value="3" />
     ...
     <div class="DoubleColumn">
        ...
        <div class="ColumnB">
            <ul>
            <li>
             <input type="text" id="slide_image_url" name="slide_image_url1" value="URL" onblur="if(this.value==''){this.value='URL'};" onclick="if(this.value=='URL'){this.value=''};" size="45"  />
             </li>
              <li>
     ...
     <div class="DoubleColumn">
        ...
        <div class="ColumnB">
            <ul>
            <li>
             <input type="text" id="slide_image_url2" name="slide_image_url2" size="45"  value="URL" onblur="if(this.value==''){this.value='URL'};" onclick="if(this.value=='URL'){this.value=''};" />
             </li>
              <li>
