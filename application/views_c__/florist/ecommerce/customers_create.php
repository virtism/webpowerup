          ...
          <h2><?php echo $title;?></h2>
              ...
              <p class="the_form_below">The fields marked with <span class="data-input_field">*</span> are mandatory. </p>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" class="registerform">
                  <tbody>
                    <tr>
                      <td class="register-section-title" colspan="3"><div>
                          <h3>Personal information</h3>
                        </div></td>
                    </tr>
                    <tr>
                      <td width="33%"><label>Gender *</label></td>
                      <td width="67%" class="fieldValue" colspan=""><input type="radio" value="Male" name="gender">
                        Male
                    ...
                    <tr>
                      ...
                      <td width="67%"><?php echo form_input($email) ?>
                        <div id="email_id" style="color: #000; font-size:10px; font-weight: bold;">Make sure you enter a valid email address</div></td>
                    </tr>
                  </tbody>
                </table>
                <table width="100%" height="149" cellpadding="0" cellspacing="0" class="registerform">
                  <tbody>
                    <tr>
                      <td width="363" class="data-name"><label>Sign up for membership</label></td>
                      <td width="704">
                      
                      <?php 
					  	//	echo "<pre>"; 	print_r($membership);	die();
					  ?>
                      <select onchange="hide_group_code(this.value), get_group_fields()" name="pending_membershipid" id="gp_drop_down" class="input_field">
                    ...
                    <tr id="group_code_field" style="display: none;">
                      ...
                      <td><input type="text" name="group_code" value="" id="group_code" size="32" onblur="checkGroupCode(this.value)">
                        <!--<span style="color: #B3B6BF; font-size: 8px; font-weight: bold;">Use your Code</span>-->
                        <div id="code_id" style="color: #B3B6BF; font-size: 8px; font-weight: bold;">Use your Code </div></td>
                    </tr>
                    <tr style="display:none;">
                      <td><input type="hidden" value="N" id="password_is_modified" name="password_is_modified"></td>
                    </tr>
                    <tr>
                      <td class="data-name"><label for="passwd1">Password *</label></td>
                      <td><?php echo form_password($password) ?>
                        <!-- <input type="password" value="" maxlength="64" size="32" class="input-input_field" name="passwd1" id="passwd1"> --></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="register-newbie-note" colspan="3" style="padding-left: 33%;"><strong style="color:#000; font-size:12px; text-transform:capitalize !important;">I accept the </strong><a target="_blank" onclick="javascript:popupOpen(this.href, '', {width:800,height:600}); return false;" href="#" style="color:#000;text-transform:capitalize !important;">"Terms &amp; Conditions"</a></td>
                    </tr>
                    <tr>
                      <td class="register-newbie-note" colspan="3" style="padding-left: 33%;">
