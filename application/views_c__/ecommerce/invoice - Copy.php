...
<form  onsubmit=" return validate()" action="<?=base_url().index_page()?>invoice/create_invoice"  enctype="multipart/form-data" method="post" id="form" >
			...
			<fieldset>
				<table onclick="calculation()" id="invoice_table" width="100%" border="0">
				  ...
				  <tr >
					...
					<td><select name="prodcut_service1"  onchange="get_ajax_product_type(1)"  style="opacity: 1; font-size:10px;" id="prodcut_service1">
				  ...
				  <tr>
						...
						<td colspan="5"  align="right">
							<table align="right">
							  ...
							  <tr>
								<td colspan="4" style="font-weight:bold;"><label>Total Tax: </label></td>
								<td colspan="5" style="font-weight:bold;"><div id="total_tax">0.00</div><input type="hidden" id="hidden_total_tax"  name="total_tax"/></td>
							  </tr>
							   <tr>
								<td colspan="4" style="font-weight:bold;"><label>Total Discount: </label></td>
								<td colspan="5" style="font-weight:bold;"><div id="total_discount">0.00</div><input type="hidden" id="hidden_total_discount"  name="total_discount"/></td>
							  </tr>
							  <tr>
							  ...
							  <tr>
								<td colspan="9" ><input name="checkbox"  type="checkbox" id="p" style="opacity: 1;" />
									<small style="padding-left:5px;">Allow client to make partial payment for this invoice</small></td>
							  </tr>
							</table>
						</td>
				  </tr>			  
							...
							<td>
								<table align="right">
									...
									<tr>
										...
										<td>
											<select id="recurring_occurrences" name="recurring_occurrences"  style="opacity: 1; font-size:10px;" >
												<option value="0" >Select</option>
												<option value="weekly">Weekly</option>
												<option value="monthly">Monthly</option>
												<option value="yearly">Yearly</option>
											</select><!--<input id="recurring_occurrences" name="recurring_occurrences" type="text" />--></td>
									</tr>
									<tr>
										<td><input style="opacity:1;" type="radio" name="rec_end_date_type" value="use_end_date" checked="checked" />End Date: (YYYY-MM-DD) </td>
										<td><input id="recurring_end_date" name="recurring_end_date" type="text" /></td>
									</tr>									
									<tr>
										<td><input style="opacity:1;" type="radio" name="rec_end_date_type" value="permanent" /><b>Permanent</b></td>
										<td>&nbsp;</td>
									</tr>	
	...
	<input id="create" name="create" value="Save As Invoice"  type="submit" />
