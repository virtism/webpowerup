...
<div class="form">
  ...
  <table id="invoice_table" onclick="calculation(<?=$j?>)"  width="100%" class="invoiceOthersTbl">
    <tr >
      <td ><div style=" float:left; width:auto; position:relative; margin-top:10px;">
        ...
        <td ><div style=" float:left; width:auto; position:relative; margin-top:10px;" id="category_dropdown'+numImages+'">
          <select size="1" style="width:150px" name="category_service'+numImages+'"  id="category_service'+numImages+'"    onchange="get_ajax_category_products('+numImages+')">
                ...
                <div class="ColumnB">
                    <ul>
                        ...
                        <li> 
                            ...
                            <input id="recurring_end_date" style="width:50px;" name="recurring_end_date" type="text" size="10" value="<?php if(isset($invoice_info[0]["recurring_end_date"])){  echo $invoice_info[0]["recurring_end_date"];   } ?>" />
