...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
        ...
        <td valign="top">
            <table id="images_uploader" width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="padding-bottom: 5px">
                        <span style="font-size:10px">URL:</span> 
                        <input class="slider_image_url" id="slide_image_url2" name="slide_image_url2" type="text" />
                    </td>
                </tr>
                <tr>
                    <td width="30%">
                    ...
                    <td style="padding-bottom: 5px">
                        <span style="font-size:10px">URL:</span> 
                        <input class="slider_image_url" id="slide_image_url3" name="slide_image_url3" type="text" />
                    </td>
                </tr>
            </table> 
    ...
    <tr>
        ...
        <td valign="top">
            <input id="slide_title" class="text" type="text" name="slide_title" maxlength="30" value="" />
    ...
    <tr>
        ...
        <td valign="top">
            <textarea id="slide_description" name="slide_description" rows="5" cols="30"></textarea>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <select id="slide_roles" name="slide_roles_list[]" multiple="multiple" style="width: 130px; margin: 0 0 20px 15px; display: none;">
            <?php
