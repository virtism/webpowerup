...
<div class="InnerMain">
<form id="frmLayout" name="frmLayout" enctype="multipart/form-data" method="post" action="<?=base_url().index_page()?>pagesController/save_upload_page_layout_desc" onSubmit="return validate()" class="niceform">
...
<form id="frmEditContent" action="<?=base_url().index_page()?>pagesController/editor_board/<?=$site_id?>/<?=$page_id?>/<?=$item_id?>" method="post" style="visibility: hidden;">
