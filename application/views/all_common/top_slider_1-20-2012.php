...
<tr>
   ...
   <?       
        ...
        ?>
            ...
            <a class="edit_slider" href="<?=base_url()?>index.php/page_editor/editSliderInfo/<?=$site_id?>/<?=$main_slideshows[$i]['slide_id']?>">Edit Slider</a>
            |
            ...
            ?>   
            <div class="slider2" id="main-babu_<?=$main_slideshows[$i]['slide_id']?>">
        ...
        <?php
           ...
           /* echo '<pre>';
            ...
            {
                $strSrc = base_url().'slideshows/'.$main_slideshows[$i]['slide_images'][$j]['slide_image'];
                $target = '';
