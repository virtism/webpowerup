  ...
  <div id="main" class="register">
          <h2><?php echo $title;?></h2>
              ...
              <p class="the_form_below">The fields marked with <span class="data-input_field">*</span> are mandatory. </p>
                ...
                <table cellspacing="0" cellpadding="0" class="registerform" width="100%">
                  <tbody>
                    <tr>
                      <td width="314" class="data-name"><label>Sign up for membership</label></td>
                      <td width="637"><select onchange="hide_group_code(this.value)" name="pending_membershipid" id="gp_drop_down" class="input_field">
