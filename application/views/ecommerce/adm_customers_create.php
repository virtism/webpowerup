...
<div class="form">
   <form method="post" class="niceform" action="<?=base_url().index_page()?>customers/customer_registration" id="registerform" name="registerform" >
   <input type="hidden" name="action" value="addCustomer" />
    <dl>
           ...
           <dd>
                ...
                <div>
                	<input id="fname" name="fname" value="" maxlength="30" size="40"  />    
                </div>
           </dd>
    </dl>
    ...
    <dl>
           ...
           <dd>
                <!--<input type="text" name="page_title" id="" size="55" />-->
                <input id="lname" name="lname" value="" maxlength="30" size="40"  />    
           </dd>
    </dl>
    ...
    <dl>
           ...
           <dd>
                <!--<input type="text" name="page_title" id="" size="55" />-->
                <input value="" maxlength="30" size="40" name="email" id="email"  onkeyup="checkEmail(this.value)" />
    ...
    <dl>
           ...
           <dd>
                <!--<input type="text" name="page_title" id="" size="55" />-->
                <input type="password" name="password" id="passwd1" value="" maxlength="30" size="40"  />    
           </dd>
    </dl>
    ...
    <dl>
           ...
           <dd>
                <!--<input type="text" name="page_title" id="" size="55" />-->
                <input type="password" name="passconf" id="passwd2" value="" maxlength="30" size="40"  />    
           </dd>
    </dl>
