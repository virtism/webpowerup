<script type="text/javascript" language="javascript">
	...
	$(document).ready(function() {
		...
		$("#addRow").click(function(){
			...
			var html = '<div class="DoubleColumn"><div class="ColumnA"><ul><li><input type="text" id="slide_main" name="slide_title'+i+'" size="45" /></li><li><textarea id="slide_desc" name="slide_description'+i+'" rows="10" cols="40"></textarea></li><li><div style=" float:left; width:100%; position:relative;"><select size="1" name="slide_target'+i+'" id="slide_target'+i+'"  style="width:340px"><option value="0">Same Window</option><option value="1">New Window</option></select></div></li></ul></div><div class="ColumnB"><ul><li><input type="text" id="slide_image_url'+i+'" name="slide_image_url'+i+'" size="45" value="http://"  onblur="if(this.value==""){this.value="http://"};" onclick="if(this.value=="http://"){this.value=""};"/></li><li><input type="file" name="slide_image'+i+'" id="slide_image'+i+'" size="35" /></li></ul></div></div>';		
...
<div class="RightColumnHeading">
    ...
    <div class="form">
<form class="niceform" action="<?=base_url().index_page()?>video_gallery/video_upload/<?=$site_id?>" enctype="multipart/form-data" method="post" id="slider_upload" name="slider_upload" >
<input type="hidden" id="count" name="numImages" value="3" />
     ...
     <div class="DoubleColumn">
        <ul>
            ...
            <li>  <label class="check_label"><a href="javascript: void(0)" id="addRow">Add more videos</a> </label> </li>
        </ul>
        
        <div class="ColumnA">
            <ul>
            <li>
             <input type="text"   name="slide_title1" id="slide_main" size="45" value="Title" onblur="if(this.value==''){this.value='Title'};" onclick="if(this.value=='Title'){this.value=''};"/>
             </li>
             <li>
        ...
        <div class="ColumnB">
            <ul>
            <li>
             <input type="text" id="slide_image_url" name="slide_image_url1" value="http://" onblur="if(this.value==''){this.value='http://'};" onclick="if(this.value=='http://'){this.value=''};" size="45"  />
             </li>
              <li>
     ...
     <div class="DoubleColumn">
        <div class="ColumnA">
            <ul>
            <li>
             <input type="text" id="slide_main" name="slide_title2" size="45"  value="Title" onblur="if(this.value==''){this.value='Title'};" onclick="if(this.value=='Title'){this.value=''};" />
             </li>
             <li>
        ...
        <div class="ColumnB">
            <ul>
            <li>
             <input type="text" id="slide_image_url2" name="slide_image_url2" size="45"  value="http://" onblur="if(this.value==''){this.value='http://'};" onclick="if(this.value=='http://'){this.value=''};" />
             </li>
              <li>
     ...
     <div class="DoubleColumn">
        <div class="ColumnA">
            <ul>
            <li>
             <input type="text" id="slide_title3" name="slide_title3" size="45" value="Title" onblur="if(this.value==''){this.value='Title'};" onclick="if(this.value=='Title'){this.value=''};"/> 
             </li>
             <li>
    ...
    <div class="ColumnB">
            <ul>
            <li>
             <input type="text" id="slide_image_url3" name="slide_image_url3" size="45" />
             </li>
              <li>
    ...
    <div class="ButtonRow">
        ...
        <a href="<?=base_url().index_page();?>video_gallery/index/<?=$_SESSION['site_id'];?>"><img src="<?=base_url();?>images/webpowerup/CancelRed.png" alt="CancelButton"/></a>
