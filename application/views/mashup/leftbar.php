...
?>      <?=$editIcon?>
        ...
        <ul>
               ...
               // $registartion_menue
               //echo '<pre>';print_r($registartion_menue[0]);
...
if(!empty($left_menus_Pbox) && $left_menus_type=='site')
{
    ...
    for($i=0; $i<sizeof($left_menus_Pbox); $i++)
    {
        ...
        if($left_menus_Pbox[$i]['box_position']=='Left')
        {
            ...
            {
                echo "<div class='box-head' style='background: #".$left_menus_Pbox[$i]['box_primary_color']."'><h2 style='color:#".$left_menus_Pbox[$i]['box_txt_color']."'>".$left_menus_Pbox[$i]['box_title']."</h2></div>";
            }
