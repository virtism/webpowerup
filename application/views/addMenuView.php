...
function addMenuItem_backup()
{
    ...
    cell4.innerHTML = '<div class="selector" id="dropdown_target'+countItems+'" name="dropdown_target'+countItems+'"><span style="-moz-user-select: none;">Select Target</span><select  name="menuTarget'+countItems+'" id="menuTarget'+countItems+'"><option value="_self">Same Window</option><option value="_blank">New Window</option></select></div>';
    cell4.align = "center"; 
}
