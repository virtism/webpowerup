...
<div class="DataGrid2">
        ...
        <span id="itemsList">   
        <ul class="TableData"><li><input type="text" name="items[0][title]" size="20" /></li><li><div  style=" position:relative; margin-top:10px; float:left"><select id="reg_items_type_0" onchange="showPopup()" size="1" name="items[0][type]"  style="width:175px;"><option value="Single-Line Text">Single-Line Text </option><option value="Multi-Line Text">Multi-Line Text</option><option value="Check Boxes">Check Boxes</option><option value="Radio Buttons">Radio Buttons</option></select></div></li><li class="Serial" ><input style="margin-left:10px;" type="checkbox" name="items[0][required]" /></li><li><input type="text" name="items[0][order]" size="20" /></li><li class="Actions"><a href="javascript:void(0)" class="DeleteAction"><img src="<?=base_url();?>images/webpowerup/DeleteAction.png" alt="button"/></a></li></ul>
        </span>
