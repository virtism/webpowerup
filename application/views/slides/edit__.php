...
<input type="hidden" id="count" name="numImages" value="3" />
    <input type="hidden" id="numImages" name="numImages" value="<?=count($slide_images)?>" />
             ...
             <input type="text" id="slide_image_url" size="45" value="<?=$row_image_info['slide_image_url']?>" name="slide_image_url<?=$counter?>" onkeypress="fade_link('<?=$fetch_id?>');" />
              ...
              <li>
                <table border="1">
                    <tr>
                        <td colspan="2">
                        <a href="<?php echo base_url(); ?>/<?=$row_image_info['slide_image']?>" class="preview"><img height="50" width="50" src="<?php echo base_url(); ?>/<?=$row_image_info['slide_image']?>" alt="Slide Show Image" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
