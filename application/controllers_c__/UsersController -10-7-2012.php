...
class UsersController extends CI_Controller {
	...
	function upgrade_package()
	{
		...
		$this->template->write_view('content','package/upgrade_packages', $data);
		$this->template->render(); 
	}
...
//            exit();
	...
	function Password_Recovery($id)

	{
		//$mail = $_POST['email_id'];
			
     //   $data['msg'] = $this->UsersModel->isMailExist($mail,$password);
	     ...
	     if($id == 1)
		 {
		  ...
		  if($id == 2)
		 {
		   $data['msg'] = "Password Recovery mail not sent";	 
		 }
