...
//		echo "i m here";exit;
	...
	function searchPage($site_id, $from){
		...
		$config = array(
			'uri_segment' => 4,
			'base_url' => base_url().'index.php/pagesController/searchPage/'.$site_id."/",
		...
		$config['base_url'] = base_url().'index.php/pagesController/searchPage/'.$site_id."/";
...
//		print_r($this->Pages_Model->getAllPages($site_id));
	//	exit;
		...
		$config = array(
			'uri_segment' => 4,
			'base_url' => base_url().'index.php/pagesController/index/'.$site_id."/",
			'per_page' => $data["pageLimit"],
			'first_link' => 'First',
			'next_link' => 'Next',
			'last_link' => 'Last',
		...
		/*$config['uri_segment'] = 4;        
		$config['base_url'] = base_url().'index.php/pagesController/index/'.$site_id."/";
		$config['per_page'] = $data["pageLimit"];     
