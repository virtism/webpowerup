...
class Page_editor extends CI_Controller
{
	...
	*/
	...
	{   
        ...
        $content = '<div>
        <h2>'.$page_title.'
        <a class="edit_title" href="http://10.1.1.50/gws/index.php/page_editor/editPageTitle/'.$site_id.'/'.$page_id.'" style="font-size:10px;">
        Edit Title
        </a></h2>
        </div>';
		...
		if($result->num_rows()>0)
		{
			...
			foreach($result->result_array() as $row)
			{
				...
				*/
				...
				//	$size = getimagesize("http://globalonlinewebsitesolutions.com/media/uploads/141585-honda-ci_1313665648.jpg");
				//	echo "<pre>";
				//	print_r($size);
				//	exit;
