...
class Pages_Model extends CI_Model{
    ...
    function addPage(){
        ...
        $this->db->query("INSERT INTO pages
            ...
            VALUES(".$this->db->escape($site_id).", ".$this->db->escape($page_title).", 'Not Default', ".$this->db->escape($page_show_title).", 
    ...
    function save_pagecontent_editorboard()
    {
        ...
        */
        ...
        for($i=0; $i<$numControls; $i++)
        {
            ...
            if($_POST['content'][$i]!='')
            {       
                $control_type = $this->input->post('control_type_'.$counter);
                $qryPageContent = "INSERT INTO page_content_controls(page_id, data, type) 
                VALUES(".$this->db->escape($page_id).", ".$this->db->escape($_POST['content'][$i]).", ".$this->db->escape($control_type).")";
