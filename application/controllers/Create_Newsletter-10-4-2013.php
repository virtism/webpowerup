...
if(!session_start()){
 ...
 //////////////////// under this all function is for news letter Goroup////////////////////////
     ...
     function save_newsletter_user()
     {
         ...
         $this->send_newsletter_group($this->input->post('NL_group_id'),$_SESSION['site_id'],$this->input->post('user_email'));
     ...
     function send_newsletter_group($group_id , $site_id , $email_NL)
      {
          ...
          $data['NLgroup']                  = $this->Newsletter_Model->get_newsletter_groups($group_id,$site_id);
