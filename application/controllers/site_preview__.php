			...
			else if(isset($gallery_data[$i]['folder_name']) && $gallery_data[$i]['folder_name'] == 'simple_thumbs')
			{
				...
				*/ 
				...
				for($j = 0; $j<count($gallery_images); $j++)
				{
					...
					$gallery_html .= '<li><a  target="'.$target.'" href="'.$url.'"><img src="'.$image_path.$image_name.'" alt="Image '.$i.$j.'" /></a></li>';
				}
				$gallery_html .= '</ul></div>';
				...
				for($j = 0; $j<count($gallery_images); $j++)
				{
					...
					$gallery_html .= '<li><a  href="javascript:void(0);" name="thumbGallery'.$i.'" ><img id="thumbSelected" src="'.$image_path.$image_name.'" alt="Image '.$i.$j.'" /></a></li>';
				}
