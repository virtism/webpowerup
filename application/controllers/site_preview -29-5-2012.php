...
//		 echo "<pre>";
	//	 print_r($data['adv_menu']);
		...
		/*  COMMENTED OPTION TURNED OFF FROM BACK END
		...
		for($i =0; $i<count($gallery_data); $i++)
		{
			...
			if(isset($gallery_data[$i]['folder_name']) && $gallery_data[$i]['folder_name'] == 'imageflow')
			{
				...
				for($j = 0; $j<count($gallery_images); $j++)
				{
					...
					$gallery_html .= '<img src="'.base_url().'galleries/'.$image_name.'" longdesc="'.base_url().'galleries/'.$image_name.'"  alt="Image '.$j.'" />';
				}
			...
			else if(isset($gallery_data[$i]['folder_name']) && $gallery_data[$i]['folder_name'] == 'simple_thumbs')
			{
				...
				for($j = 0; $j<count($gallery_images); $j++)
				{
					...
					$gallery_html .= '<li><a  target="'.$target.'" href="'.$url.'"><img src="'.base_url().'galleries/'.$image_name.'" alt="Image '.$j.'" /></a></li>';
				}
				...
				for($j = 0; $j<count($gallery_images); $j++)
				{
					...
					$gallery_html .= '<li><a  href="javascript:void(0);"><img id="thumbSelected" src="'.base_url().'galleries/'.$image_name.'" alt="Image '.$j.'" /></a></li>';
				}
