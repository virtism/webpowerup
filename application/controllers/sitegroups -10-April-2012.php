			...
			<div class="section" id="paypal_row">
				<div>
					<form action="<?=$this->paypal_lib->paypal_url?>" method="post" >
						...
						<input type="hidden" name="return" value="<?=base_url().index_page()?>MyAccount/register/">
						<input type="hidden" name="cancel_return" value="<?=base_url().index_page()?>MyAccount/register/">
						...
						<input type="hidden" name="custom" value="<?=$group_id?>">
