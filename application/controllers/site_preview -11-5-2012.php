...
//		 echo "<pre>";
	...
	//	print_r($rowPage);
		...
		{	
...

			{
				...
				<tr>
				<td></td>
				<td><input type='submit' value='Send Message' class=submit/></td>
				</tr>
	...
	{   
...

		{
			...
			if($gallery_data[$i]['folder_name']=='imageflow')

			{

			

				if(isset($gallery_data[$i]['file_type']) && $gallery_data[$i]['file_type'] == 'css')

				{

					
					$gallery_html .= '<link type="text/css" rel="stylesheet" href="'.base_url().'galleries_templates/imageflow/css/'.$temp_name.'/'.$gallery_data[$i]['files'].'" />';	

				}

				else if(isset($gallery_data[$i]['file_type']) && $gallery_data[$i]['file_type'] == 'js')

				{

					$gallery_html .= '<script type="text/javascript" src="'.base_url().'galleries_templates/imageflow/js/'.$gallery_data[$i]['files'].'"></script>';	
...

			{
...

				{
					...
					$gallery_html .= '<link type="text/css" rel="stylesheet" href="'.base_url().'galleries_templates/simple_thumbs/css/'.$temp_name.'/'.$gallery_data[$i]['files'].'" />';	
...

				{
					...
					$gallery_html .= '<script type="text/javascript" src="'.base_url().'galleries_templates/simple_thumbs/js/'.$gallery_data[$i]['files'].'"></script>';	
		...
		if(isset($gallery_data[0]['folder_name']) && $gallery_data[0]['folder_name'] == 'imageflow')

		{
...

			{
				...
				if(isset($gallery_data[$i]['gallery_image']))

				{

					$image_exp = explode('.',$gallery_data[$i]['gallery_image']);
				...
				$gallery_html .= '<img src="'.base_url().'galleries/'.$image_name.'" longdesc="'.base_url().'galleries/'.$image_name.'"  alt="Image '.$i.'" />';

			}

			

			$gallery_html .= '</div><br clear="all"/>';
		...
		else if(isset($gallery_data[0]['folder_name']) && $gallery_data[0]['folder_name'] == 'simple_thumbs')

		{
			...
			$gallery_html .='<div id="large_image_holder"><ul id="large_images">';
...

			{
				...
				$gallery_html .= '<li><a  href="javascript:void(0);"><img src="'.base_url().'galleries/'.$image_name.'" alt="Image '.$i.'" /></a></li>';
			...
			$gallery_html .= '<div id="content_left"><ul id="thumb_holder">';
...

			{
				...
				$gallery_html .= '<li><a  href="javascript:void(0);"><img id="thumbSelected" src="'.base_url().'galleries/'.$image_name.'" alt="Image '.$i.'" /></a></li>';

			}

			

			$gallery_html .= '<br clear="all"/></ul></div>';
...
/*					if(!empty($row['image_width']))
...

				{
					...
					$content .= "<h2>Download detailed document<a target=".$row['image_target']."  href=' ".$dwld_link." '> ".$link_name[7]."</a></h2>"; 
