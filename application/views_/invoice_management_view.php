    ...
    <div class="DataGrid2">
            ...
            <ul>
                ...
                <li class="Actions">
                   ...
                   <a style="color: white; font-size: 10px; text-shadow: 0px 0px #006AAA; background-color: #006AAA; border: 0px #006AAA solid;"  href="<?php echo base_url().index_page(); ?>invoice/create_email_invoice/<?=$invoice['invoice_id']?>">Email</a> | 
                    <a style="color: white; font-size: 10px; text-shadow: 0px 0px #006AAA; background-color: #006AAA; border: 0px #006AAA solid;" href="<?=base_url().index_page()?>invoice/create_view_invoice/<?=$invoice['invoice_id']?>">Print</a> | 
                    <a style="color: white; font-size: 10px; text-shadow: 0px 0px #006AAA; background-color: #006AAA; border: 0px #006AAA solid;" target="_blank" href="<?php echo base_url().index_page(); ?>invoice/create_pdf_invoice/<?=$site_id.'/'.$invoice['invoice_id']?> ">PDF</a> | 
                    <a style="color: white; font-size: 10px; text-shadow: 0px 0px #006AAA; background-color: #006AAA; border: 0px #006AAA solid;" href="<?=base_url().index_page()?>invoice/customer_new_invoice/<?=$invoice['invoice_id']?>/<?=$invoice['customer_id']?>" >New</a>
                    <b><?=$invoice['status']?></b>
                </li>
            </ul>
            <?php
