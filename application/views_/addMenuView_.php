...
<form onclick="resetFormControls()" id="frmAddMenu" name="frmAddMenu" onsubmit="return validate()" action="<?=base_url().index_page()?>menusController/addMenu/<?=$site_id?>" method="post"> 
    <fieldset>
