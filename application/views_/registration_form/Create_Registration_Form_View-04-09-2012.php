...
$(document).ready(function(e) {
	...
	$("#addCheckItem123").click(function(e) {
		 
	  addCheckItem(i);
	 });
		   
	$("#addRadioItem123").click(function(e) {
...
<div class="DataGrid2">
        ...
        <dl>
              ...
              <label for="color" class="NewsletterLabel">Make This A Survey (STORE AND SHOW RESULTS): </label></dt>
...
<div class="DataGrid2" style="overflow:hidden">
    ...
    <div id="Multi-Line Text_0" style="display:none;">
        ...
        <tbody><tr>
            ...
            <td><input type="text" size="10" value="40" id="textarea_width" name="textarea[0]" class="dinput"></td>
        </tr>
        <tr>
            <td align="right"><label for="textarea_height" class="dinput">Height (rows): </label></td>
            <td><input type="text" size="10" value="5" id="textarea_height" name="textarea[1]" class="dinput"></td>
        </tr>
        </tbody></table>
    </div>
