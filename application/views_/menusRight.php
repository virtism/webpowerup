<?php 
$resultMenu = $this->Menus_Model->getMenu("Right", "EveryOne");
...
<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px black;margin-top:8px;">
    ...
    <tr>
        ...
        <ul>
            ...
            <li><a href="<?=$rowPage["page_seo_url"];?>"><?=$rowMenuItem["item_name"];?></a></li>
            <?php endforeach;?>            
        </ul></td>
        <?php
        }
...
endforeach;?>
<?php 
$resultMenu = $this->Menus_Model->getMenu("Right", "Registered");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
...
endforeach;?>
<?php 
$resultMenu = $this->Menus_Model->getMenu("Right", "Other");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
