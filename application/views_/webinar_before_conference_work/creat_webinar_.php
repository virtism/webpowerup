...
<form name="webinar_data" action="<?=$action?>" method="post" id="webinar_data">
...
<!--			 <input type="text" name="ck_content_data" id="ck_content"  />-->
	...
	<tr>
		...
		?>
			<label>
				<input type="radio" id="page_access_1" name="webinar_access" value="Everyone" onClick="hideRoles()" <?=$str_check_default?> <?=(isset($webinar_info["webinar_access"]) &&  $webinar_info["webinar_access"] == "Everyone") ? "checked='checked'" : ""?> /> Everyone
			</label>    <br>
			<label>
