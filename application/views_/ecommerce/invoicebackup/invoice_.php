			...
			<fieldset>
				<table onclick="calculation()" id="invoice_table" width="100%" border="0">
				  ...
				  <tr>
					...
					<td>
					<select id="product1" name="product1" onchange="get_ajax_product_data(1)" style="opacity: 1;">
							...
							<td>
								<table >
									...
									<tr>
										...
										<td><input id="order_number" name="order_number" type="text" /></td>
									</tr>
									<tr>
										<td><span class="required">&nbsp;</span>Occurrences: </td>
										<td><input id="occurrences" name="occurrences" type="text" /><br/>(Enter 0 to bill forever)</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
							...
							<td>
								<table align="right">
									...
									<tr>
										...
										<td><input id="biller_email" name="biller_email" type="text" /></td>
									</tr>
									<tr>
										<td>Email customer after each recurrence: </td>
										<td><input id="customer_email" name="customer_email" type="text" /></td>
									</tr>									
								</table>
						   </td>
						</tr>
