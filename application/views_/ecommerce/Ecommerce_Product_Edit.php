...
<input type="hidden" id="sub_att1" name="sub_att1" value="1"/>
		 ...
		 <div class="tab">  
		  ...
		  <ul class="TableHeader">
		   ...
		   <span id="slideShowItems">   
			...
			<!-- digital product yes option Start-->
			<div id="DigOptDiv" >
				<dl>
					<dt>
					...
					<dd>
					<? //print_r($digital); ?>
						<input type="text" name="digital_max_download" id="digital_max_download" value = "<? if(isset($digital['products_attributes_max_download'])){ echo $digital['products_attributes_max_download']; }?>" size="55" />
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input type="text" name="digital_download_expire" id="digital_download_expire" value = "<? if(isset($digital['products_expire_days'])){ echo $digital['products_expire_days']; }?>"    size="55" />
					</dd>
				</dl>
				<dl>
					<dt>
					...
					<dd>
						<input type="text" name="digital_download_url" id="digital_download_url"  value = "<? if(isset($digital['products_attributes_url'])){ echo $digital['products_attributes_url']; }?>" size="55" />
					</dd>
				</dl>
				<dl>
					<dt>
						<label class="NewsletterLabel">Upload File</label>
					</dt>
					<dd>
						<input type="file" name="digital_product"  id="digital_product"   size="55" />
						 <input type="hidden" name="previous_product"  value = "<? if(isset($digital['products_attributes_filename'])){ echo $digital['products_attributes_filename']; }?>"/>
					</dd>
				</dl>
			</div>
			<!-- digital product yes option End-->
	...
	<div class="tab">
		...
		<a id="add_tabs" href="javascript:void(0)"><img src="<?=base_url();?>images/webpowerup/show.png"  /></a> | <a id="delete_tabs"  href="javascript:void(0)"><img src="<?=base_url();?>images/webpowerup/hide.png" /></a>
