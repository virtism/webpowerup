...
//Fucntion will create new row and append in table
	...
	$(document).ready(function() {
		$('#addnewrow').click(function(){
			...
			var html = '<ul class="TableData" ><li style="width:160px !important; min-width:160px !important; min-width:160px !important;" ><div style=" float:left; width:auto; position:relative; margin-top:10px;"><select size="1" style="width:150px" name="prodcut_service'+numImages+'" onchange="get_ajax_product_type('+numImages+')" id="prodcut_service'+numImages+'" ><option value="0">Select</option><option value="Regular" >Products</option><option value="Digital" >Digital Products</option><option value="Meeting" >Video Conference</option></select></div></li><li id="product_dropdown'+numImages+'"><div style=" float:left; width:auto; position:relative; margin-top:10px;"><select size="1" onchange="get_ajax_product_data('+numImages+')" id="product'+numImages+'" name="product'+numImages+'" ><? foreach($products as $key => $product){ echo "<option value=".$key.">".$product."</option>";} ?></select><div></li><li class="Serial"><input type="text" size="1" id="description'+numImages+'" name="description'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="ucost'+numImages+'" name="ucost'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="quantity'+numImages+'" name="quantity'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="discount'+numImages+'" name="discount'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="taxone'+numImages+'" name="taxone'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="taxtwo'+numImages+'" name="taxtwo'+numImages+'" /></li><li class="Serial"><input type="text" size="1" id="price'+numImages+'" name="price'+numImages+'" /></li></ul>';
    ...
    <?php 
            ...
            <div class="DoubleColumn">
                ...
                <div class="ColumnA">
                    <ul>
                     <li> 
                     <input type="radio" value="existing" name="customer_type" id="customer_type" onclick="get_all_site_customers()" />
                     ...
                     <input type="radio" checked="checked" value="new_customer" name="customer_type" id="new_customer" onclick="new_customers()" />
            ...
            <div class="DataGrid2">
                ...
                <span id="invoiceRow">    
                    <ul class="TableData" >
                        ...
                        <li class="Serial"><input type="text" name="" id="" size="1" /></li>
                        <li class="Serial"><input type="text" name="" id="" size="1" /></li>
                        <li class="Serial"><input type="text" name="" id="" size="1" /></li>
                        <li class="Serial"><input type="text" name="" id="" size="1" /></li>
                        <li class="Serial"><input type="text" name="" id="" size="1" /></li>
            ...
            <div class="DoubleColumn">
                ...
                <div class="ColumnB">
                    ...
                    <label class="RightAlignText">0.00</label>
                    </li>
