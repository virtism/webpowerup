...
<?php
	...
	echo form_open(base_url().'index.php/MyAccount/register',$attributes);
...
<table cellspacing="1" summary="Register" class="data-table register-table" style="margin-left: 20px;">
			...
			<tr>
				...
				<td class="fieldValue" colspan=""><input type="radio" value="Male" class="required" name="gender">&nbsp;&nbsp;Male&nbsp;&nbsp;<input type="radio"  checked="checked" value="Female" name="gender" class="required">&nbsp;&nbsp;Female&nbsp;</td>
			</tr>
 ...
 <tbody>
   ...
   <tr>
	  ...
	  <td>
		 ...
		 <!-- <input type="password" value="" maxlength="64" size="32" class="input-required" name="passwd1" id="passwd1">  -->
	  </td>
   </tr>
   <tr>
	  ...
	  <td>
		  ...
		  <!--<input type="password" value="" maxlength="64" size="32" class="input-required" name="passwd2" id="passwd2">-->
