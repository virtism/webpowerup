...
#fancybox-close {
     ...
     width: 30px;
     height: 30px;
     background: transparent url('file:///C|/Users/Virtism/AppData/Local/temp/fz3temp-1/fancybox.png') -40px 0px;
     cursor: pointer;
     z-index: 1103;
...
<fieldset>
                    ...
                    <dl>
                           ...
                           <dd>
                                     <a id="group_users" class="group_users_popup" href="#popup2" onclick="displayPopup()" >See all Groups and users.</a>
