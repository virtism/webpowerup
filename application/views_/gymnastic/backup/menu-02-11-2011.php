         ...
         if(count($menu)>0 || ! empty($menu))
           for($i=0; $i<count($menu); $i++)
           {
            ...
            <div class="nevibuttona">
                <div class="leftroundnevibtn"> <img src="<?=base_url(); ?>css/gymnastic/images/navigationnormalbuttonleftround.png" /></div>
                <div class="midnevibtn">
                    <div class="titlemidnevibtn"> <a href="<?=$strLink?>"> <?=$menu[$i]['page_title']?> </a> </div>
                </div>
                <div class="rightroundnevibtn"> <img src="<?=base_url(); ?>css/gymnastic/images/navigationnormalbuttonrightround.png" /> </div>
            </div>
            <div class="empty"> </div>  
            <?php   
           }
       ...
       if(!empty($other_top_navigation) || count ($other_top_navigation) > 0 )
           for($a=0; $a<count($other_top_navigation); $a++)
           {
            ...
            <div class="nevibuttona">
                <div class="leftroundnevibtn"> <img src="<?=base_url(); ?>css/gymnastic/images/navigationnormalbuttonleftround.png" /></div>
                <div class="midnevibtn">
                    <div class="titlemidnevibtn"> <a href="<?=$strLink?>"> <?=$other_top_navigation[$a]['title']?> </a> </div>
                </div>
                <div class="rightroundnevibtn"> <img src="<?=base_url(); ?>css/gymnastic/images/navigationnormalbuttonrightround.png" /> </div>
            </div>
            <div class="empty"> </div>               
