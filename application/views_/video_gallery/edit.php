...
<script type="text/javascript" language="javascript">
	...
	$(document).ready(function() {
		...
		var html = '<div class="DoubleColumn"><div class="ColumnA"><ul><li><input type="text" id="slide_main" name="slide_title'+numImages+'" size="45" /></li><li><textarea id="slide_desc" name="slide_description'+numImages+'" rows="10" cols="40"></textarea></li><li><div style=" float:left; width:100%; position:relative;"><select size="1" name="slide_target'+numImages+'" id="slide_target'+numImages+'"  style="width:340px"><option value="0">Same Window</option><option value="1">New Window</option></select></div></li></ul></div><div class="ColumnB"><ul><li><input type="text" id="slide_image_url'+numImages+'" name="slide_image_url'+numImages+'" size="45" value="URL"  onblur="if(this.value==""){this.value="URL"};" onclick="if(this.value=="URL"){this.value=""};"/></li><li><input type="file" name="slide_image'+numImages+'" id="slide_image'+numImages+'" size="35" /></li></ul></div></div>';		
