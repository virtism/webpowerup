...
<p align="center"><h2>Edit CONTACT</h2></p>
<div id="default">
<p><div class="error_msg" align="center"> <?php echo validation_errors(); ?> </div></p>
 ...
 <?php
    ...
    $attributes = array('class' => 'contact', 'id' => 'contact_form', 'name' => 'edit_contact');
    echo form_open(base_url().index_page().'Edit_Contact/update_contact', $attributes);
      echo form_hidden('id',$values[0]['contact_id']);
    $contact_name = array(
              'name'        => 'contact_fname',
              'id'          => 'contact_fname',
            //  'maxlength'   => '100',
             // 'size'        => '50',
           //   'style'       => 'width:15%',
              'value'       => set_value('contact_fname',$values[0]['contact_name'])
            );
     $contact_country = array(
             ...
             // 'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_country',$values[0]['contact_country'])
            );
    $contact_state = array(
              'name'        => 'contact_state',
              'id'          => 'contact_state',
            //  'maxlength'   => '100',
             // 'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_state',$values[0]['contact_state'])
            );
    $contact_city = array(
              'name'        => 'contact_city',
              'id'          => 'contact_city',
             ...
             // 'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_city',$values[0]['contact_city'])
            );
   $contact_address = array(
           ...
           //   'size'        => '50',
            //  'style'       => 'width:15%',
              'value'       => set_value('contact_address',$values[0]['contact_address'])
            );                                                             
   $contact_zip = array(
              'name'        => 'contact_zip',
              'id'          => 'contact_zip',
           //   'maxlength'   => '100',
             // 'size'        => '50',
            //  'style'       => 'width:15%',
              'value'       => set_value('contact_zip',$values[0]['contact_zip'])
            );
   $contact_position = array(
           ...
           //   'size'        => '50',
            //  'style'       => 'width:15%',
              'value'       => set_value('contact_position',$values[0]['contact_position'])
            );
   $contact_phone = array(
              'name'        => 'contact_phone',
              'id'          => 'contact_phone',
           ...
           //   'size'        => '50',
            //  'style'       => 'width:15%',
              'value'       => set_value('contact_phone',$values[0]['contact_phone'])
            );
   $contact_fax = array(
              'name'        => 'contact_fax',
              'id'          => 'contact_fax',
            ...
            //  'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_fax',$values[0]['contact_fax'])
            );  
   $contact_google_code = array(
            ...
            //  'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_google_code',$values[0]['contact_google_code'])
            );
   $contact_extra_info = array(
            ...
            //  'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => set_value('contact_extra_info',$values[0]['contact_extra_info'])
            );
   $contact_publish_yes = array(
            ...
            //  'size'        => '50',
             // 'style'       => 'width:15%',
              'value'       => $values[0]['contact_publish'],
