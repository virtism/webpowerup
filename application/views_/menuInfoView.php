            ...
            <li>
             ...
             <li>
                ...
                { ?> 
                   ...
                   <input type="hidden" name="lstItemPage[]" id="custom_url_<?=$i?>" value="clink_<?=$i?>" />                            <? 
                } 
                else 
                { 
