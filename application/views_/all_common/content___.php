	...
	if(allowed)
	{
		...
		({
			...
			success: function(data)
			{
				...
				if(action == "Published")
				{
					var a_html = '<a id="unpublish" onclick="publich_unpublish_title(this,\'No Published\')" href="javascript: void(0);" >Unpublish</a> Your Page Title !';
					$('#row_start_title').html(a_html);
				}
				else
				{
					var a_html = '<a id="publish" onclick="publich_unpublish_title(this,\'Published\')" href="javascript: void(0);" >Publish</a> Your Page Title !';
					$('#row_start_title').html(a_html);
				}
			}
		});
...
?>
    <td valign="top">
		...
		<span style="padding-left:5px;" id="row_start_title">
        ...
        ?>
            <div>
				...
				<?
					...
					{
						//Comments for only logged in Users
						if(isset($show_fb_comments) && $show_fb_comments == "true")
						{
							?>
								<div id="fb-root"></div>
									...
									<!--<script src=
									"http://static.ak.connect.facebook.com/js/api_lib/v0.4/FeatureLoader.js.php" type="text/javascript"></script>
									-->
									<fb:comments href="http://www.globalonlinewebsitesolutions.com/" num_posts="5" 
