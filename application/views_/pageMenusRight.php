<?php 
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Everyone", "All");
...
<?php 
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Everyone", "Other");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
...
{ 
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Registered", "All");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
...
if($this->session->userdata("user_id"))
{ 
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Registered", "Other");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
...
{
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Other", "All");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
...
if($this->session->userdata("user_id") && $this->session->userdata("role_id"))
{
$resultMenu = $this->Menus_Model->getPageMenus($page_id, "Right", "Other", "Other");
foreach($resultMenu->result_array() as $rowMenu):
    $resultMenuItem = $this->Menus_Model->getMenuItem($rowMenu['menu_name']);
    $boolDisplay=false;
    if($rowMenu['menu_published']=='Yes'){
