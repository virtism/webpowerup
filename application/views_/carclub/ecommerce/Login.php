...
<td></td>
<td></td>
<td class="btn_submit"><?php echo form_submit('submit','Login >>'); ?></td>
</tr>
...
<a class="forgot_pass" href="<?=base_url().index_page()?>MyAccount/Password_Recovery" title="Forgot password?" style="display:none;"><span>Forgot password?</span></a>
