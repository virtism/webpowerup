...
<div class="register" id="main">
              ...
              <p class="the_form_below">The fields marked with <span class="data-input_field">*</span> are mandatory. </p>
                ...
                <table cellspacing="0" cellpadding="0"  width="100%" class="registerform">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="67%"><?php echo form_input($email) ?><br />
                        <div style="color: #B3B6BF; font-size: 8px; font-weight: bold;" id="email_id">Make sure you enter a valid email address</div></td>
                    </tr>
                  </tbody>
                </table>
                <table cellspacing="0" cellpadding="0" class="registerform" width="100%">
                  <tbody>
                    <tr>
                      <td width="354" class="data-name"><label>Sign up for membership</label></td>
                      <td width="713"><select class="input_field" id="gp_drop_down" name="pending_membershipid" onchange="hide_group_code(this.value)">
                    ...
                    <tr>
                      <td style="padding-left: 33%;" colspan="3" class="register-newbie-note"><strong style="color:#FFF; font-size:12px; text-transform:capitalize !important;">I accept the </strong><a style="color:#fff;text-transform:capitalize !important;" href="#" onclick="javascript:popupOpen(this.href, '', {width:800,height:600}); return false;" target="_blank">"Terms &amp; Conditions"</a></td>
                    </tr>
                    <tr>
                      <td style="padding-left: 33%;" colspan="3" class="register-newbie-note"><?php   echo form_submit('submit','Continue'); ?></td>
                    </tr>
                  </tbody>
                </table>
              <?php echo form_close();?>
