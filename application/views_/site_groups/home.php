            ...
            if(count($groups_array) >0)
            {
                ...
                <ul >
                    ...
                    <li class="Actions">
                        ...
                        <br />
                        <?php /*?><a href="<?=site_url()?>sitegroups/edit_group/<?=$groups_array[$i]["id"]?>">Edit</a>|<?php */?> <a style="color: white; font-size: 10px; text-shadow: 0px 0px #006AAA; background-color: #006AAA; border: 0px #006AAA solid;" href="<?=base_url().index_page()?>sitegroups/status_group/<?=$groups_array[$i]["id"]?>">
                  <?=$action_text?>
                  </a>
                   <br>
                   <a style="color: white; font-size: 10px; text-shadow: 0px 0px #424B59; background-color: #424B59; border: 1px #424B59 solid;" href="<?=site_url()?>sitegroups/submits/<?=$groups_array[$i]["id"]?>">Submissions</a>
                    </li>
