...
<?php
    ...
    echo form_open('customers/customer_registration',$attributes);
    echo form_hidden('action','addCustomer');
    //echo form_hidden('step',$step);
    echo form_hidden('step','step2');
    
    $f_name = array('name'=>'f_name','id'=>'f_name','size'=>'32' , 'maxlength' => '32', 'value' => set_value('f_name','')); 
    $last_name = array('name'=>'last_name','id'=>'last_name','size'=>'32' , 'maxlength' => '32' , 'value' => set_value('last_name',''));
     
    $address = array('name'=>'address','id'=>'address', 'rows'=>'3' , 'cols'=>'25' , 'value' => set_value('address',''));
    $city = array('name' => 'city', 'id' => 'city','size'=>'32' , 'maxlength' => '64' , 'value' => set_value('city',''));  
    $state = array('name' => 'state', 'id' => 'state','size'=>'32' , 'maxlength' => '64' , 'value' => set_value('state',''));  
    $post_code = array('name' => 'post_code', 'id' => 'post_code', 'size'=>'32' , 'maxlength' => '32' , 'value' => set_value('post_code',''));    
  ...
  <table width="100%" cellspacing="1" cellpadding="3" summary="Address book">
    <tbody>
      ...
      <tr>
          ...
          <td class="data-required">*</td>
          <td>
            <select onchange="check_zip_code_field(this, $('#zipcode').get(0))" id="country" name="country" style="width: 219px;">
