...
//							index($site_id,$webinar_id)
			...
			{
	?>
				<?php /*?><li ><a class="active" href="<?=base_url().index_page()?>site_preview/page/<?=$menu[$i]["site_id"]?>/<?=$menu[$i]["page_id"]?>"><?=$menu[$i]["page_title"]?></a></li><?php */?>
				<li >
					<a class="active"  href="<?=$strLink?>"><?=$link_caption?></a>
				</li>   
	<? 
			}
			else
			{
	?>
				<?php /*?><li ><a href="<?=base_url().index_page()?>site_preview/page/<?=$menu[$i]["site_id"]?>/<?=$menu[$i]["page_id"]?>"><?=$menu[$i]["page_title"]?></a></li><?php */
				?>
				<li >
