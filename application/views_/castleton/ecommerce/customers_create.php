...
?>
	<div class="register" id="main">
         <h2><?php echo $title;?></h2>
              <p class="the_form_below" style="color:#000;">The form below allows you to create a profile which is necessary to place orders.
              ...
              <p class="the_form_below">The fields marked with <span class="data-input_field">*</span> are mandatory. </p>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="67%"><?php echo form_input($email) ?>
                        <div style="color: #000; font-size: 10px; font-weight: bold;" id="email_id">
                ...
                <table cellspacing="0" cellpadding="0" class="registerform" width="100%">
                  <tbody>
                    <tr>
                      <td width="355" class="data-name"><label>Sign up for membership</label></td>
                      <td width="712">
			...
			?>
                    ...
                    <tr style="display: none;" id="group_code_field">
                      ...
                      <td><input type="text" onblur="checkGroupCode(this.value)" size="32" id="group_code" value="" name="group_code" />
                        ...
                        <div style="color: #000; font-size: 8px; font-weight: bold;" id="code_id">Use your Code </div></td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding-left: 33%;" colspan="3" class="register-newbie-note"><strong style="color:#000; font-size:12px; text-transform:capitalize !important;">I accept the </strong><a style="color:#000;text-transform:capitalize !important;" href="#" onclick="javascript:popupOpen(this.href, '', {width:800,height:600}); return false;" target="_blank">"Terms &amp; Conditions"</a>
					  </td>
                    </tr>
                    <tr>
                      <td style="padding-left: 33%;" colspan="3" class="register-newbie-note">
