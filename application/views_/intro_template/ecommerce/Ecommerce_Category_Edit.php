...
<form action="<?=base_url().index_page()?>Categories_Management/edit" name="reg_form" id="reg_form" class="contact" enctype="multipart/form-data" method="post">
 ...
 <?php
   ...
   // echo form_open(base_url().index_page().'Categories_Management/edit', $attributes); 
