...
class PagesController extends CI_Controller{
   ...
   function ajax_content_add()
	...
	function basic_info($site_id, $private='')
	{
//		echo "i m here";exit;
		//checks user login
		$link = substr(uri_string(),1);
		$info_link = base_url().$link;
	...
	function success($page_id, $site_id)
	{
		...
		$data["page_id"] = $page_id;
		$data["site_id"] = $site_id;
		$data['is_private'] = $_SESSION['private'];
...
//		print_r($this->Pages_Model->getAllPages($site_id));
    ...
    function private_pages($site_id, $from){ 
	...
	function get_groups_members()
	{
		...
		$members = $this->Groups_Model->get_multiple_group_members();
			...
			if($members)
			{
				...
				$html = "<select name=\"members[]\"  style=\"opacity:1;\">";
