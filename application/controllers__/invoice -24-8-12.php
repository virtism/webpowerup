  ...
  class Invoice extends CI_Controller{
	...
	function invoice_managment_view()
	{
	  ...
	  function ajax_call_customers($data = 0)
	  {
		 ...
		 if($count>0)
		 {
		 	echo $data = $this->Groups_Model->get_site_gropus_customer_by_site_id($this->site_id, 'single');	  	
		 }
		 else
		 {
		...
		<tr>
			<td>
				<table >
					<tr>
						<td>First Name: </td>
						<td><input id="fname" name="fname" type="text" value="<? if(isset($detail['customer_fname'])){ echo $detail['customer_fname']; }?>" /></td>
					</tr>
					<tr>
						<td>Last Name: </td>
						<td><input id="customer_lname" name="customer_lname" type="text"  value="<? if(isset($detail['customer_lname'])){ echo $detail['customer_lname']; }?>"/></td>
					</tr>
					<tr>
						<td>Company: </td>
						<td><input id="customer_company" name="customer_company" type="text"  value="<? if(isset($detail['customer_company'])){ echo $detail['customer_company'];}?>" /></td>
					</tr>
					<tr>
						<td>Email: </td>
						<td><input id="email" name="email" type="text" value="<? if(isset($detail['customer_email'])){ echo $detail['customer_email']; }?>" /></td>
					</tr>
					<tr>
						<td>Phone Number: </td>
						<td><input id="pnumber" name="pnumber" type="text" value="<? if(isset($address_detail['address_book_phone'])){ echo $address_detail['address_book_phone']; } ?>" /></td>
					</tr>
				</table>
			</td>
			<td>
				<table align="right">
					<tr>
						...
						<td><input id="saddress" name="saddress" type="text" value="<? if(isset($address_detail['address_book_address'])){ echo $address_detail['address_book_address']; } ?>" /></td>
					</tr>
					<tr>
						<td>country: </td>
						<td>
							<select id="country" name="country" onchange="get_ajax_states()" style="opacity: 1;" >
							...
							<?php /*?><input id="country" name="country"  type="text"  value="<? if(isset($address_detail['address_book_country'])){ echo  $address_detail['address_book_country']; }?>" /><?php */?>						
						</td>
					</tr>
					<tr>
						<td>State/Province</td>
						<td  id="state_option">
							<?php /*?><input id="state" name="state" type="text"  value="<? if(isset($address_detail['address_book_state'])){ echo  $address_detail['address_book_state']; }?>" /><?php */?>
					...
					<tr>
						<td>City: </td>
						<td><input id="city" name="city" type="text" value="<? if(isset($address_detail['address_book_city'])){ echo $address_detail['address_book_city']; }?>"  /></td>
					</tr>
					<tr>
						<td>ZIP/Postal Code: </td>
						<td><input id="zip" name="zip" type="text" value="<? if(isset($address_detail['address_book_zipcode'])){ echo $address_detail['address_book_zipcode']; }?>" /></td>
					</tr>
				</table>
		   </td>
		</tr>
	...
	function get_ajax_product_type()
	{
		...
		//print_r($products);
			if(count($products)>1)
				{
			?>
					<select id="product<?=$row_type?>" name="product<?=$row_type?>" onchange="get_ajax_product_data(<?=$row_type?>)" style="opacity: 1; font-size:10px;">
	...
	//	$tax = 
		...
		$notes = array('notes' => '' );
		$this->cezpdf->ezTable($notes_array,$notes, 'Invoice Notes', array('xPos' => 80,'showLines' =>0,'titleFontSize' => 14,'rowGap' => -5));
