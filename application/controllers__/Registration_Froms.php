...
if(!session_start()){
  ...
  class Registration_Froms extends CI_Controller{
      ...
      { 
        ...
        $show_data['view_all_records'] = $this->Registration_Forms_Model->get_all_form($this->site_id);
        // $this->load->view('Registration_Froms_View',$show_data);
        $this->template->write_view('content','registration_form/Registration_Froms_View',$show_data);
	  ...
	  function details()
	  {
        ...
        $this->template->write_view('content','registration_form/registration_form_details',$data);
        $this->template->render();
	  }
	  ...
	  function submits($form_id)
	  {
		...
		//echo "<pre>";print_r($data['submits']);exit;
	    $data['form_id'] = $form_id;
        $this->template->write_view('content','registration_form/registration_form_submit',$data);
        $this->template->render();
	  }
	  ...
	  function submit_detail($submit_id)
	  {
        ...
        $this->load->view('registration_form/registration_form_submit_detail',$data);
     ...
     function   view_registration_form ()
     {
      ...
      $this->template->write_view('content','registration_form/Registration_Froms_View_User',$data);
      $this->template->render();
