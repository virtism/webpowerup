...
$template['intro_template']['template'] = '../templates/intro_template/template';
$template['intro_template']['regions'] = array(
		 'title',
		 'description',
		 'keywords',
		 'header',
...
$template['intro_template']['parser'] = 'parser';
$template['intro_template']['parser_method'] = 'parse';
$template['intro_template']['parse_template'] = FALSE;

//---------salima-pirani Template---------------------//

$template['salima-pirani']['template'] = '../templates/salima-pirani/template';
$template['salima-pirani']['regions'] = array(
		 'title',
		 'description',
		 'keywords',
		 'header',
...
$template['salima-pirani']['parser'] = 'parser';
$template['salima-pirani']['parser_method'] = 'parse';
$template['salima-pirani']['parse_template'] = FALSE;


//---------	webpowerup	---------------------//

$template['webpowerup']['template'] = "../templates/webpowerup/template";
$template['webpowerup']['regions'] = array(
		"title",
		"header",
		"leftColumn",
		"UserInfo",
...
$template['webpowerup']['parser'] = 'parser';
$template['webpowerup']['parser_method'] = 'parse';
$template['webpowerup']['parse_template'] = FALSE;
