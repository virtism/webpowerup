	...
	function updateMenu(){
		...
		if($intNumItems>0)
		{
			...
			for( $i=0; $i<$intNumItems; $i++ )
			{
				...
				if(!empty($_POST['strCustomLink']))
				{
					
					$strCustomLink 	= $_POST['strCustomLink'][$i];
				}
				
				$this->db->query("INSERT INTO menuitems(item_name, item_published, item_status,item_link, item_target) VALUES('".$txtItemName."',  '".$rdoItemPublished."', 'Active','".$strCustomLink."','".$menuTarget."')");
