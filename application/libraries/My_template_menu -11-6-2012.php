	   ...
	   // $data['color_scheme'] = $this->Menus_Model->get_scheme_color($site_id);
		...
		if(array_key_exists('default',$color_scheme) && $color_scheme['default'] != '' && $color_scheme['default'] != 'Default'){
		 ...
		 //	';
		  ...
		  $my_css_anchor = ' 
				a.link_style:link , a.link_style:visited {color: #'.trim($anchor_txt).' !important;  background-color: #'.trim($anchor_backgroud).' !important;}
			   /* a.link_style:visited {color: #'.trim($anchor_txt).' !important;  background-color: #'.trim($anchor_backgroud).' !important;} */
				a.link_style:hover {color: #'.trim($anchor_back_txt).' !important;  background-color: #'.trim($anchor_back_active).' !important;}
			   /* a.link_style:focus {color: #'.trim($anchor_txt).' !important;  background-color: #'.trim($anchor_backgroud).' !important;}  */
				a.link_style:active , a.link_style:hover {color: #'.trim($anchor_back_txt).' !important;  background-color: #'.trim($anchor_back_active).' !important;}
			';
