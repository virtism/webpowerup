<div class= "products" style="  width: 745px ! important; padding: 15px 0px 190px 15px; margin-top:-8px;">
<? if(isset($cat_title))
	{  
		echo '<h1 style="font-size:16px; margin-top: -6px;">'.$cat_title.'</h1>'; 
	}
?>
...
if (count($products)<1){
	if($ishome == 'yes')
 	{
	 	echo '<h2 style="margin-top: -6px; margin-left: -12px; font-size: 16px;">Please Select a category !</h2>';
 	}
 	else
 	{
