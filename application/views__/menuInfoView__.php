            ...
            <li>
             ...
             <li>
                ...
                { ?> 
                   ...
                   <input type="text" size="18" value="<?=$rowItemInfo["item_link"]?>"  id="_lstItemPage<?=$i;?>" name="_lstItemPage<?=$i;?>">
