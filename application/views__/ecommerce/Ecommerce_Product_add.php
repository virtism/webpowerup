...
$(document).ready(function(e) {
	...
	$('#add_tabs').click(function(){
		...
		var ul = document.getElementById("tab_container");
		var liNodes = [];
...
<form action="<?=site_url()?>Products_Management/create/<?=$invoice_create_time?>" method="post" name="add_product" id="add_product" class="niceform"  enctype="multipart/form-data">
		 ...
		 <fieldset>
			 ...
			 <div id="tab1" class="tab">
				<dl>
					...
					<dd><input type="text" name="product_name" id="product_name" size="55" /></dd>
				</dl>
				
				 <dl>
					<dt><label for="email" class="NewsletterLabel">Short Description :</label></dt>
					<dd><textarea name="short_desc" id="short_desc" rows="10" cols="42"></textarea></dd>
				</dl>
				
				<dl>
					<dt><label for="email" class="NewsletterLabel">Title Tag :</label></dt>
					<dd><textarea name="title_tag" id="title_tag" rows="10" cols="42"></textarea></dd>
				</dl>
				
				 <dl>
					<dt><label for="email" class="NewsletterLabel">Meta Keywords :</label></dt>
					<dd><textarea name="meta_key" id="meta_key" rows="10" cols="42"></textarea></dd>
				</dl>
				
				<dl>
					<dt><label for="email" class="NewsletterLabel">Meta Description :</label></dt>
					<dd><textarea name="meta_desc" id="meta_desc" rows="10" cols="42"></textarea></dd>
				</dl>
			 </div>
			...
			<div class="tab">
				<dl>
				<dt><label for="email" class="NewsletterLabel">Long Description :</label></dt>
				<dd><textarea name="full_desc" id="full_desc" rows="10" cols="42"></textarea></dd>
			</dl>
			</div>
			...
			<div class="tab">
				...
				<dd><input type="text" name="price" id="price" size="55" /></dd>
			</dl>
			...
			<dl>
				...
				<dd>
					...
					<input type="radio" name="taxable_rd" id="taxable_rd2" value="No" checked="checked" />
					<label class="check_label">Yes</label>
					<input type="radio" name="taxable_rd" id="taxable_rd1" value="Yes"  />
					<br /><br />
					
					<div id="taxableDiv" style="display:none;">
						<div style="float:left;">
						<input type="text" name="price_tax" id="price_tax" size="25" />
						</div>
			...
			<div class="tab">
			  ...
			  <label for="email" class="NewsletterLabel">Category :</label></dt>
				...
				{
					echo "Please create category to assign product.";
				}
			...
			<?php /*?><dl>
				...
				<dd>
					...
					<input type="radio" name="access_permision" id="access_permision1" value="Everyone" checked="checked" />
					<label class="check_label">Everyone</label>
					<input type="radio" name="access_permision" id="access_permision2" value="Registered" />
					<label class="check_label">All Registered Users</label>
					<input type="radio" name="access_permision" id="access_permision3" value="Other" />
					<label class="check_label">Only Users With a Certain Access Level</label>
					<br><br>
					<div style="display: none; margin:5px 5px 5px 5px; float:left;" id="roles" > 
			...
			<div class="tab">
					...
					<dd>
						...
						<input type="radio" name="image_rd" id="image_rd2" value="No" checked="checked" />
						<label class="check_label">Upload a new image</label>
						<input type="radio" name="image_rd" id="image_rd1" value="Yes" />
		  ...
		  <ul class="TableHeader">
		   ...
		   <span id="slideShowItems">   
			...
			<dl style="display:none;">
				...
				<dd>
					<label class="check_label">Yes</label>
					<input type="radio" name="digital_pro" id="digital_pro1" value="Digital" checked="checked"  />
					<label class="check_label">No</label>
					<input type="radio" name="digital_pro" id="digital_pro2" value="Regular"  />
				</dd>
			</dl>
			...
			<div id="DigOptDiv" >
				...
				<dl>
					...
					<dd>
						<input type="text" name="digital_download_expire" id="digital_download_expire"  size="55" />
					</dd>
				</dl>
				<dl>
					<dt>
			...
			<!-- digital product yes option -->
			<!-- Simple product yes option Start -->
			 <?php /*?><div id="SimpOptDiv" >     
				<dl>
					<dt><label for="email" class="NewsletterLabel">Quantity in stock (items) :</label></dt>
					<dd><input type="text" name="qty_in_stock" id="qty_in_stock" value="1000" size="55" /></dd>
				</dl>     
				  
				<dl>
					<dt><label for="email" class="NewsletterLabel">Low Limit in Stock :</label></dt>
					<dd><input type="text" name="low_avail_limit" id="low_avail_limit" size="55" value="10" /></dd>
				</dl> 
				
				<dl>
					<dt><label for="email" class="NewsletterLabel">Minimum order quantity :</label></dt>
					<dd><input type="text" name="min_order_qty" id="min_order_qty" size="55" value="1" /></dd>
				</dl>
				<dl>
					<dt><label for="email" class="NewsletterLabel">Product return time (days) :</label></dt>
					<dd><input type="text" name="pd_return_time" id="pd_return_time" size="55" value="0" /></dd>
				</dl>
				
				
				<dl>
					<dt><label for="email" class="NewsletterLabel">Weight (lbs) :</label></dt>
					<dd><input type="text" name="weight_lbs" id="weight_lbs" size="55" value="0.00" /></dd>
				</dl> 
				...
				<dl>
					...
					<dd>
						<label class="check_label">Yes</label>
						<input type="radio" name="free_shipping" id="free_shipping1" value="Yes" />
						<label class="check_label">No</label>
						<input type="radio" name="free_shipping" id="free_shipping2" value="No" checked="checked" />
					</dd>
				</dl> 
				<dl>
					<dt><label for="email" class="NewsletterLabel">Shipping freight ($) :</label></dt>
					<dd><input type="text" name="shipping_freight" id="shipping_freight" size="55" value="0.00" /></dd>
				</dl>      
				<dl>
					...
					<dd>
						...
						<input type="checkbox" name="us_dimensions_for_shipping" id="us_dimensions_for_shipping" value="Yes" checked="checked" />
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						...
						<input type="text" name="box_length" id="box_length" value="0.00" size="15" />
						</div>
						
						<div style=" display:inline; float:left;">
						<label class="check_label">Width</label>
						<input type="text" name="box_width" id="box_width" value="0.00" size="15" />
						</div>
						
						<div style=" display:inline; float:left;">
						<label class="check_label">Height</label>
						<input type="text" name="box_height" id="box_height" value="0.00" size="15" />
						</div>
					</dd>
				</dl> 
				...
				<dl>
					...
					<dd>
						...
						<input type="checkbox" name="separate_box" id="separate_box" value="Yes" checked="checked" />
					</dd>
				</dl>
				
				<dl>
					<dt><label for="email" class="NewsletterLabel">Quantity per shipping box :</label></dt>
					<dd><input type="text" name="items_per_box" id="items_per_box" size="55" /></dd>
				</dl>
			</div><?php */?> 
			<!-- Simple product yes option Start -->
			</div>
			
		   <?php /*?> <div class="RightColumnHeading">
				<h1 class="createroom">
			...
			<dl>
				...
				<dd><input type="text" name="length" id="length" size="55" /></dd>
			</dl>
			<dl>
				<dt><label for="email" class="NewsletterLabel">Cm Width :</label></dt>
				<dd><input type="text" name="width" id="width" size="55" /></dd>
			</dl>
			<dl>
				<dt><label for="email" class="NewsletterLabel">Cm Height :</label></dt>
				<dd><input type="text" name="height" id="height" size="55" /></dd>
			</dl>
			<dl>
				<dt><label for="email" class="NewsletterLabel">Cm Weight:</label></dt>
				<dd><input type="text" name="weight" id="weight" size="55" /></dd>
			</dl>
			</div>
	...
	<div class="tab">
		...
		<div id="attributes_options">
			<div style="padding-top:5px; float:left;">
				<a id="add_tabs" href="javascript:void(0)"> <img src="<?=base_url();?>images/webpowerup/New.png" alt="AddMoreField"/></a>  <a class="DeleteAction" id="delete_tabs"  href="javascript:void(0)"><img src="http://localhost/webpowerup/images/webpowerup/Trash.png" alt="button"></a>
			</div>
					...
					<li id="tab_container_li1">
						<div id="tab1" class="tabs">
							...
							<table id="attribute_table1" width="99%" border="0" cellspacing="0" cellpadding="0" class="heading_table">
							  <tr >
								<td style="padding:5px; float:left;" colspan="3"><br />
									<a id="addattrow" href="javascript:void(0)" onClick="addAttRow(1)"><img src="<?=base_url();?>images/webpowerup/AddMoreField.png" alt="AddMoreField"/></a>     
									<a href="javascript:void(0)"  onClick="deleteAttRow(1)" id="remove"><img src="<?=base_url();?>images/webpowerup/Close.png"/></a>
								</td>
							  </tr>
		...
		<ul class="TableData">
			...
			<li class="imagefield">
			 ...
			 <dl>
				...
				<dd>
					...
					<input type="radio" name="sku_allow" id="sku_allow1" value="Automatically" checked="checked" />
					<label class="check_label">Use a Custome SKU</label>
					<input type="radio" name="sku_allow" id="sku_allow2" value="Custome" />
				</dd>
			</dl>
			...
			<dl>
			 ...
			 <dl>
				...
				<dd>
					<label class="check_label">Yes</label>
					<input type="radio" name="publish" id="publish1" value="Yes" checked="checked" />
					<label class="check_label">No</label>
					<input type="radio" name="publish" id="publish2" value="No" />
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<div class="ButtonRow">
						...
						<button type="submit" >
							<img src="<?=base_url();?>images/webpowerup/AddGreen.png" alt="Add Green"/>
						</button>
