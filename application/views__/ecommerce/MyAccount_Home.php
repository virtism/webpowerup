...
?>
  ...
  <div class="contentText">
    <ul class="accountLinkList">
      <li><span class=""></span><a href="<?='http://'.$_SERVER['SERVER_NAME']?>/myaccount/account.html">My account information.</a></li>
      <li><span class=""></span><a href="<?='http://'.$_SERVER['SERVER_NAME']?>/myaccount/AddressBook.html"> My address book.</a></li>
      <li><span class=""></span><a href="<?='http://'.$_SERVER['SERVER_NAME']?>/myaccount/password_change.html">Change  password.</a></li>
      
      <li><span class=""></span><a href="<?='http://'.$_SERVER['SERVER_NAME']?>/group_managment/">Edit Groups</a></li>
      
      <?php
	  if($private_page_exist)
	  { ?>
      <li><span class=""></span><a href="<?='http://'.$_SERVER['SERVER_NAME']?>/myaccount/private_pages.html">Private Pages</a></li>
      <?php
	  } ?>
