    ...
    <?php 
            ...
            <div class="DataGrid2">
                <ul class="TableHeader">
                    <li style="width:160px !important; min-width:160px !important; min-width:160px !important; display:none;">Product/Service</li>
                    <li >Options</li>
                ...
                <div class="ColumnB">
                    <ul>
                        ...
                        <li> 
                            ...
                            <input id="recurring_end_date" name="recurring_end_date"  type="text" size="20" />                            
                            </div>
                        </li>
                        <li> 
