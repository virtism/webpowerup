...
<div class="RightColumnHeading">
    <h1>
        ...
        <span>Edit a Photo Gallery</span>
    </h1>
    
</div>       
        
<div class="form">
<form class="niceform" action="<?=base_url().index_page()?>gallery_management/edit_gallery/<?=$gallery_id?>/<?=$site_id?>" onsubmit="return validate()" enctype="multipart/form-data" method="post" >
                    ...
                    <tr>
                        <td colspan="2">
							<?php
                                ...
                                ?>
                                <a href="<?=base_url().$path.$g_image?>" class="preview">
