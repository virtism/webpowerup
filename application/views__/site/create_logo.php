...
<div class="RightColumnHeading">
    <h1>
        ...
        <span>Upload Your Site Logo</span>
    </h1>
 ...
 if ( $this->session->flashdata('rsp_logo') != "")
 {
   ...
   <?php
     ...
     <input type="hidden" name="code" value="<?=$site_id.date('his')?>" />
                  ...
                  <div class="ColumnB" style="width:500px; text-align:right;">
                    <ul>
                    <li>
                     <label class="NewsletterLabel">Existing Logo Image: </label>
                     <?php 
					 if($logo != "") 
					 { ?>
        				<div class="canvas" style="margin-left:50px">
                    	<img class="logo" src="<?=base_url()?>media/ckeditor_uploads/<?=$_SESSION['user_info']['user_login'].'_'.$_SESSION['user_info']['user_id']?>/logo/<?=$logo?>" alt="Logo" />
                ...
                <div class="ColumnA" style="width:600px; margin-top:40px;">
                    <ul>
                    <li>
                    <label class="NewsletterLabel"><span class="star">*</span>Upload Logo Image: </label>
                    <div style=" float:left; display:inline; width:290px;">
                     <input type="file" name="logo_image" id="logo_image"  />
                       <small style="margin-top:5px; color:#CCCCCC;">Formate Allowed(jpg, png, gif)</small>
                     </div>
                     <button type="submit" >
                ...
                <div class="ColumnA" style="width:480px;">
                    <ul>
                        ...
                        <label class="NewsletterLabel">Publish </label>
                         <? 
						 $checked = "";
	  ...
	  ?>
                        <div style="float:left; display:inline; width:50px;">
                     		<input type="checkbox" name="logo_check" id="logo_check" checked="<?=$checked?>"  value="Yes" />
                     	</div>
                           <button type="submit" value="save" name="save_publish">
