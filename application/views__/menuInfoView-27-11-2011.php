    ...
    <fieldset>
        ...
        <div class="section">
            ...
            <div>
                ...
                <?php
                $rowItemInfo = $menu_items->result_array();
                if($rowItemInfo[0]['is_main_menu'] == 'Yes')
                {
                ?> 
                <tr>
                    <th width="30%">Caption</th>
                    <th width="25%">Destination</th>
                    <th width="20%">Sub menu of (Parent)</th>
...
?>
                        ...
                        <td align="center">
                            <div class="selector">
                                <span style="-moz-user-select: none;"><?=$this->Menus_Model->getParent_title($rowItemInfo["item_id"])?>
