	 ...
	 <div id="mid" style="<?=$strStyle?>">		 
		...
		//		if(isset($left_menus) && sizeof($left_menus) == 0 )	// This statement runs in live view
			...
			*/	
					...
					{
					?>      			
                        <div class="right_col" style="float:left; margin:0 3px 0 0 !important;">
                            <div class="side_bar">
                                <?=$leftbar?>
                            </div>
            ...
            if(isset($right_menus) && sizeof($right_menus) > 0 )
            {
                ...
                ?>		
                  ...
                  <div class="right_col" style="float:right;"><!--Side Bar wil come here-->
