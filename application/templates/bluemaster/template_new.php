...
<div id="backgroundshine" style="<?=$strStyle?>">
	...
	<div id="wrapper"  style="<?=$background_color?>"><!--Main Outer wrapper div of body starts Here-->
