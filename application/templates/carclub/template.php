...
<?php
	...
	{
		$strStyle .= ' width:413px;';
	}
	else if ( (isset($left_menus) && sizeof($left_menus) > 0 ) || (isset($right_menus) && sizeof($right_menus) > 0) ) // if one side menu is present
	{
		$strStyle .= ' width:679px;';
	}
	else // if no side menu is present
	{
	...
	{
?>		 
    <div class="right_menu_bar" style="float:left; width:220px !important; "  >
		<?//=$sidebar?>
     	<?=$leftbar?>			
    </div>
...
<?php	// right side menu
	...
	{ ?>
		<div  class="right_menu_bar" style="float:right; width:220px !important;"  >
