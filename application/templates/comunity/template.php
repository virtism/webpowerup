...
?> 		
	...
	*/
	...
	?>		
	   ...
	   <div class="sideMenu" style="float:left; width:250px;">
  		  <?//=$sidebar?>
		   <?=$leftbar?>
	...
	?>
  	<div class="slider_box" style=" <?=$strStyle?> ">
	...
	<?php
    ///		Right side Menu 		///
    if(isset($right_menus) && sizeof($right_menus) > 0 )	// if menu exist
    {
        ...
        ?>		
          ...
          <div class="sideMenu" style="float:right; width:250px;"><!--Side Bar wil come here-->
