...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>css/bluegray/style.css" type="text/css" media="screen" />
    <!--[if IE 6]><link rel="stylesheet" href="<?php echo base_url(); ?>css/bluegray/style.ie6.css" type="text/css" media="screen" /><![endif]-->
    <!--[if IE 7]><link rel="stylesheet" href="<?php echo base_url(); ?>css/bluegray/style.ie7.css" type="text/css" media="screen" /><![endif]-->

    <script type="text/javascript" src="<?php echo base_url(); ?>css/bluegray/jquery.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>css/bluegray/script.js"></script>
</head>
<body>
<div id="art-main">
    <div class="art-sheet">
        ...
        <div class="art-sheet-body">
            ...
            <?php $this->load->view('bluegray/header'); ?>       
...
<div class="art-nav">
       <?php $this->load->view('bluegray/menu'); ?>
</div>
<div class="cleared reset-box"></div>
  ...
  <!--  end Right side bar     --> 
    ...
    <?= $content ?> 
            ...
            <div class="art-footer">
                <?php $this->load->view('bluegray/footer'); ?>   
            </div>
            <div class="cleared"></div>
