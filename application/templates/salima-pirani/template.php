...
<li><a href="#" class="t"></a></li>
   ...
   <? }} ?>
	...
	else if ( isset($right_menus) && sizeof($right_menus) > 0 )
	...
	else if ( isset($left_menus) && sizeof($left_menus) > 0  )

	{

		$strStyle .= ' width:728px;';
   ...
   <div class="right_bar"  style=" <?=$strStyle?> " ><!--Main contents of the body will come here-->
	...
	<?php
     ...
     { ?>
        ...
        <div class="left_bar" style="float:right;">
