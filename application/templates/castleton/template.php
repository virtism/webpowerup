...
?>
	<? 
		...
		{
	?>		
			<div class="col_left" style="float:left; width:260px;"> 
			  <? //=$sidebar?>
			  <?=$leftbar?>
			 </div>
	<?
  ...
  <? 
	...
	{
?>		
		<div class="col_left" style="float:right;width:260px;"> 
		  <? //=$sidebar ?>
		  <?=$rightbar?>
		 </div>
<?
