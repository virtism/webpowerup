...
<div id="container" <?=$background_color?> >
  ...
  <?php
	...
	//echo $background_image.'---------------------'.$background_area.'------------------'.$background_styl;exit;
...
?>
        <div class="topinfonlogo" <?=$strStyle?>>
          ...
          <!---With Actual Height--->
          <img src="<?=base_url()?>media/ckeditor_uploads/<?=$_SESSION['user_info']['user_login'].'_'.$_SESSION['user_info']['user_id']?>/images/headers/<?=str_replace(' ','_',$header_image)?>" style=" margin: auto;" /> </div>
        <?php       }
...
?>
        <div class="slideshow" >
          ...
          <img style="margin: auto; padding-top: 11px;"  src="<?=base_url()?>headers/<?=str_replace(' ','_',$rowImage["header_image"])?>" />
          <?php
	...
	?>
        <div class="topinfonlogo" <?=$strStyle?>>
          ...
          <div class="smallinfotop">
            <div class="toplinea"> sit amet, consectetuer adipiscing elit, nonummy. </div>
            <div class="toplineb"> Lamet, consectetuer adipiscing elit, nonummy. </div>
            <div class="toplineb"> Lorem amet, sed diam nonummy. </div>
          </div>
        </div>
        <?php
