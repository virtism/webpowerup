...
<a
class="li_style"
href="<?=$strLink?>"><?=$other_top_navigation[$a]['title']?></a>
</li>
<?php
}
}
...
{
?>
<img style="width:960px; height:125px; margin: auto; padding-top: 11px;"
src="<?=base_url()?>headers/<?=$rowImage["header_image"]?>" /> <?php
}
?>
...
?>		
    ...
    <div class="col_left" style="float:left; width:335px;" ><!--Side Bar wil come here-->
    ...
    <div class="col_right" style=" float:left; <?=$strStyle?>"><!--Main contents of the body will come here-->
	...
	if(isset($right_menus) && sizeof($right_menus) > 0 )
	{
		...
		?>		
		  ...
		  <div class="col_left" style="float:right; width:335px; "><!--Side Bar wil come here-->
